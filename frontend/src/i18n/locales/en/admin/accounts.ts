export default {
    accounts: {
      ...
      proxyPool: {
        ...
        hint: 'Rotate smoothly by proxy capacity, skipping unavailable routes. Account concurrency is the sum of all entries.',
        add: 'Add Proxy',
        remove: 'Remove Proxy',
        proxy: 'Proxy',
        ...
        defaultConcurrency: 'New proxy concurrency',
        defaultConcurrencyHint: 'New proxies default to 20 concurrent requests and can be adjusted individually.',
        limitsHint: 'Bind up to {maxEntries} proxies with at most {maxConcurrency} total concurrency.',
        addAll: 'Add all available ({count})',
        allAdded: 'No more proxies available. Check proxy status or add a new proxy.',
        unavailable: 'This proxy is unavailable. Replace or remove it.',
        missingProxy: 'Proxy #{id} (unavailable)'
      },
      concurrency: 'Concurrency',
      ...
      testModelsLoadFailed: 'Unable to load test models. Close and retry.',
      testNoModelsAvailable: 'No test models are available for this account.',
