export default {
    accounts: {
      ...
      toolActions: 'Tools',
      autoReauth: {
        title: 'Automatic Login Authorization',
        configure2fa: 'Configure 2FA',
        reauthorize2fa: 'Reauthorize with 2FA',
        notBound: '2FA not configured',
        bound: '2FA configured',
        importNew: 'Import and authorize new accounts',
        rowStatusUnavailable: 'Authorization status unavailable',
        rowStatusLoading: 'Loading authorization status…',
        bindHint: 'Save the login email, password, and 2FA secret for this account. Expired authorization will recover using the original login flow.',
        originalProxy: 'Always uses the original account proxy #{id}; groups, concurrency, multiplier, and other settings are preserved.',
        bindingProxyMissing: 'Assign a fixed proxy in the account settings before configuring automatic authorization.',
        pasteLine: 'Paste one line of login details (optional)',
        fillFields: 'Fill fields',
        loginEmail: 'Login email',
        loginPassword: 'Account password',
        totpSecret: 'Permanent 2FA secret',
        secretsAlreadySaved: 'Saved passwords and 2FA secrets are never displayed. Fill both fields to replace the details, or use the controls below to toggle recovery.',
        autoRecover: 'Automatically recover expired authorization',
        saveBinding: 'Save login details',
        saveBindingHint: 'Saving details does not start a login. Use “Reauthorize now” below to recover immediately.',
        bindingSaved: 'Login details saved. Expired authorization will recover automatically, or you can reauthorize now.',
        bindingSavedDisabled: 'Login details saved. Automatic recovery is currently disabled. Enable it below when needed.',
        loadErrors: {
          schema_unavailable: 'The authorization database schema is outdated. Run backend database migrations, then refresh.',
          status_unavailable: 'Could not read authorization status. Check the database connection; retrying automatically.',
          endpoint_unavailable: 'This backend does not provide the automatic authorization endpoint yet. Update and restart the backend, then refresh.',
          unauthorized: 'Your session has expired. Sign in to the administrator account again.',
          forbidden: 'This account cannot view authorization status. Use an administrator account.',
          server_error: 'The authorization service failed. Retrying automatically. Check the backend and database migrations.',
          network_error: 'Could not connect to the authorization service. Retrying automatically.'
        },
        description: 'Configure automatic login for OpenAI OAuth accounts. Invalid authorization is refreshed first, then login and 2FA use the original account proxy. Recovered accounts resume accepting requests.',
        workerMissing: 'The automatic login service is not configured. Configure and start the browser login service on the server first.',
        keyMissing: 'The login credential encryption key is not configured. Set a persistent key on the server before importing or enabling accounts.',
        importLabel: 'Import login details for new accounts',
        importHint: 'One account per line: email----password----TOTP secret. Password spaces and backslashes are preserved. Use the authenticator’s permanent Base32 secret, not a six-digit verification code.',
        importPlaceholder: 'email----password----TOTP secret',
        secretHint: 'Details are encrypted for automatic login and excluded from account exports. The input is cleared after import or when the panel closes.',
        proxyLabel: 'Fixed proxy for new accounts',
        noProxy: 'Select a fixed proxy (required)',
        proxyHint: 'New accounts require a proxy with a fixed exit IP. Existing accounts keep their original proxy. A rotating proxy cannot guarantee an unchanged exit IP.',
        groupsHint: 'Groups are optional and apply only to new accounts.',
        preserveHint: 'New accounts are created and queued for login, becoming available after authorization. For existing accounts, choose “Configure 2FA” in the account list.',
        importAction: 'Import and authorize',
        importing: 'Saving…',
        importResults: 'Import results by line',
        validLine: 'Format valid',
        line: 'Line {line}',
        accountsLabel: 'Automatic authorization accounts',
        pollHint: 'Status updates every 5 seconds while this panel is open. Submitted login tasks continue in the background after closing.',
        account: 'Account', status: 'Status', lastSuccess: 'Last successful authorization', actions: 'Actions',
        attempts: '{count} attempts', nextAttempt: 'Next attempt: {time}', enable: 'Enable', disable: 'Disable', retry: 'Reauthorize now',
        empty: 'No accounts configured for automatic authorization.',
        loadFailed: 'Could not load authorization status. Retrying automatically.',
        proxiesFailed: 'Could not load proxies. Reopen this panel to retry.',
        noAvailableProxies: 'No fixed proxies are available. Add and enable a proxy in Proxy Management, then return to import accounts.',
        importFailed: 'Submission was not confirmed. Refresh the account list to check the outcome before retrying.',
        actionFailed: 'The action was not confirmed. Refresh the status before retrying.',
        manualFailed: 'Manual authorization did not complete. Use the original account and proxy. If a login task is running, wait for it to finish and generate a new authorization link.',
        manualAction: 'Authorize manually',
        manualHint: 'Configure your browser to use the same fixed proxy assigned to this account before opening the authorization link. Success clears only the authorization block and preserves manual disable and quota limits.',
        statuses: {
          bound: '2FA configured', starting: 'Preparing authorization', browser_login: 'Logging in and completing 2FA',
          idle: 'Waiting for authorization failure', queued: 'Queued', pending: 'Pending', refreshing: 'Refreshing token',
          logging_in: 'Logging in', awaiting_2fa: 'Completing 2FA', exchanging: 'Exchanging authorization', verifying: 'Verifying authorization',
          running: 'Authorizing', ready: 'Authorized', recovered: 'Recovered', success: 'Authorized', succeeded: 'Authorized',
          failed: 'Authorization failed', retry_wait: 'Waiting to retry', cooldown: 'Cooling down', blocked: 'Action required', needs_manual: 'Manual action required',
          awaiting_manual: 'Awaiting manual action', manual_required: 'Manual action required', disabled: 'Disabled', created: 'Created',
          updated: 'Updated', imported: 'Imported', unknown: 'Awaiting status update'
        },
        errors: {
          account_exists: 'The account already exists. Configure its 2FA from the account list.',
          identity_unknown: 'The original login email is unknown. Add the account email first.',
          invalid_account: 'Automatic authorization requires a primary OpenAI OAuth account.',
          configuration_failed: 'Could not save automatic authorization settings. Check the backend and retry.',
          credentials_updated: 'Login details changed. Choose Reauthorize now to recover this account.',
          invalid_format: 'Use email----password----TOTP secret, one account per line.',
          invalid_email: 'Invalid email address.', password_required: 'Password is required.',
          invalid_totp_secret: 'Enter a permanent Base32 TOTP secret, not a verification code.',
          invalid_totp: 'Invalid TOTP secret or code. Check the secret and server clock.',
          duplicate_email: 'Duplicate email in this batch.', proxy_required: 'New accounts require a fixed proxy.',
          invalid_proxy: 'The proxy is unavailable. Select a valid fixed proxy.', proxy_not_found: 'The assigned proxy no longer exists.',
          proxy_unavailable: 'The assigned proxy is unavailable. The task has stopped.', proxy_pool_not_supported: 'Assign a single fixed proxy to this account.',
          proxy_changed: 'The account proxy changed. Check it before authorizing again.', proxy_ip_changed: 'The proxy exit IP changed. The task has stopped.',
          account_not_found: 'Account not found.', account_ambiguous: 'Multiple accounts match this email. Resolve the duplicates first.',
          account_conflict: 'The matching account is not eligible. Check for duplicate accounts or an incompatible account type.',
          account_changed: 'Account settings changed during the task. Check them before retrying.', account_mismatch: 'The login identity does not match the original account.',
          identity_mismatch: 'The login identity or workspace does not match. Credentials were not replaced.', credentials_missing: 'Login details have not been configured.',
          worker_not_configured: 'The browser login service is not configured.', encryption_key_not_configured: 'The credential encryption key is not configured.',
          login_failed: 'Login failed. Check the details before retrying.', invalid_credentials: 'Invalid login details.', invalid_password: 'Invalid login password.',
          totp_failed: '2FA failed. Check the secret and server clock.', manual_required: 'Additional verification requires manual authorization.',
          captcha_required: 'Complete the CAPTCHA manually.', email_otp_required: 'Complete email verification manually.',
          device_verification_required: 'Confirm the device manually.', network_error: 'A login network request failed. Waiting to retry.',
          timeout: 'Login timed out. Try again later.', disabled: 'Automatic authorization is disabled.', busy: 'An authorization task is already running.',
          cooldown: 'Cooling down. Wait for the next attempt.', rate_limited: 'Login requests are limited. Try again later.',
          invalid_group: 'The selected group is unavailable.', group_not_found: 'The selected group no longer exists.', import_failed: 'This line could not be imported. Check account settings before retrying.',
          refresh_failed: 'Token refresh failed.', state_changed: 'Account state changed. Refresh before retrying.',
          oauth_configuration_error: 'Invalid OAuth client configuration. Check the server configuration.', persistence_failed: 'Could not save the authorization result. Check server status before retrying.',
          worker_unavailable: 'The browser login service is temporarily unavailable.', lock_unavailable: 'Another task is processing this account. Try again later.',
          secret_unavailable: 'Encrypted login details could not be read. Check the encryption key or import them again.', unknown: 'The operation failed. Check the configuration or authorize manually.',
          invalid_request: 'Invalid login task parameters. Check the configuration.', invalid_callback: 'Invalid authorization callback. Authorize again.',
          unauthorized: 'Login service authentication failed. Check the server configuration.', payload_too_large: 'The submission is too large. Import fewer accounts per batch.',
          unsupported_proxy: 'The browser does not support this proxy configuration. Use a supported fixed proxy.', unsupported_totp: 'This TOTP configuration is unsupported. Use a standard TOTP secret.',
          state_mismatch: 'Authorization sessions do not match. The task has stopped.', oauth_error: 'OAuth authorization did not complete. Check the account or authorize manually.',
          untrusted_login_origin: 'The login destination is not trusted. The task has stopped.', login_timeout: 'Login timed out. Try again later.',
          cancelled: 'The login task was cancelled.', browser_unavailable: 'The login browser is unavailable. Check the login service.',
          login_navigation_failed: 'Could not open the login page. Check the proxy.', login_flow_unsupported: 'This login flow requires manual action.',
          workspace_selection_required: 'Select the original account workspace manually.', email_verification_required: 'Complete email verification manually.',
          account_disabled: 'The upstream account is disabled. Check its status.', credentials_rejected: 'Login details were rejected. Check the email, password, and TOTP secret.'
        }
      },
      viewColumns: 'Columns',
