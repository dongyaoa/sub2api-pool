export default {
  intelligenceMonitor: {
    ...
    started: 'Started', finished: 'Finished', duration: 'Generation time', totalDuration: 'Total duration', durationMinutesSeconds: '{minutes} min {seconds} sec', http: 'HTTP status', runSource: 'Source for this run', rate: 'Effective rate', rateUnknown: 'Rate unavailable', rateStale: 'Last known rate', rateAtRun: 'Rate at run time', notes: 'Notes', autoRate: 'Fetched automatically',
    ...
    form: {
      ...
      rateHint: 'A note for this external source. The automatically fetched effective rate is recorded separately.', enabled: 'Scheduled testing', interval: 'Interval', timeout: 'Maximum wait per run', timeoutHint: 'Choose 5–15 minutes; the default is 15 minutes to allow reasoning and animation generation.',
      customInterval: 'Custom', customSeconds: 'Custom interval (seconds)', intervalPlaceholder: 'For example: 45', intervalHint: 'Enter a whole number from 30 to 86400 seconds. The default is 1 hour.', validInterval: 'Enter a whole number from 30 to 86400 seconds.',
