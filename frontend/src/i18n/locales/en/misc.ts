export default {
  ...
  version: {
    ...
    sourceModeHint: 'This is a source build. Update and rebuild from the Pool repository. Container updates require a release image.',
    checking: 'Checking the Pool image…',
    checkUnknown: 'Update status is unknown. Refresh to try again.',
    statusUnknown: 'The update service status is unavailable. An update cannot be started yet.',
    helperNotConfigured: 'First install the Pool update service on the host and configure the application connection.',
    helperUnavailable: 'The Pool update service is unavailable. Check the service on the host.',
    recoveryRequired: 'The previous update was interrupted. Check and recover the container on the host before continuing.',
    updateUnavailable: 'Container updates are not enabled for this deployment.',
    setupInstructions: 'View initial setup instructions',
    authRequired: 'Administrator access expired or was denied. Automatic checks have stopped. Sign in again.',
    confirmTitle: 'Update Pool image',
    confirmContainerUpdate: 'Update to v{version} and recreate the container? Service will be briefly interrupted.',
    submitting: 'Submitting the update job…',
    reconnecting: 'The container may be restarting. Waiting for the service to return without resubmitting the update.',
    monitorTimeout: 'Automatic polling stopped after 25 minutes. The job may still be running. Check the update service on the host or refresh its status.',
    verifying: 'Verifying the running version and revision…',
    rolledBackFailure: 'The update failed and the previous image was restored. This update did not complete.',
    jobStates: {
      queued: 'Update queued',
      pulling: 'Pulling the Pool image',
      recreating: 'Recreating the container',
      checking: 'Checking the new container',
      succeeded: 'Verifying the update result',
      failed: 'Update failed',
      rolled_back: 'Update failed; previous image restored'
    },
