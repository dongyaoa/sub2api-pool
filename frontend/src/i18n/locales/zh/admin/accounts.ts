export default {
    accounts: {
      ...
      autoReauth: {
        title: '自动登录授权',
        configure2fa: '配置 2FA',
        reauthorize2fa: '2FA 重新授权',
        notBound: '未绑定 2FA',
        bound: '已绑定 2FA',
        importNew: '导入新账号并授权',
        rowStatusUnavailable: '授权状态暂不可用',
        rowStatusLoading: '加载授权状态…',
        bindHint: '为此账号绑定登录邮箱、密码和 2FA 密钥。授权失效后自动沿用原登录授权流程恢复。',
        originalProxy: '始终使用账号原代理 #{id}；保留分组、并发、倍率和其他设置。',
        bindingProxyMissing: '请先在账号设置中绑定固定代理，再配置自动授权。',
        pasteLine: '粘贴单行登录资料（可选）',
        fillFields: '填入下方',
        loginEmail: '登录邮箱',
        loginPassword: '账号密码',
        totpSecret: '2FA 长期密钥',
        secretsAlreadySaved: '已保存的密码和 2FA 密钥不会回显。更换资料时请重新填写两项；仅开关自动恢复可使用下方操作。',
        autoRecover: '授权失效后自动重新授权',
        saveBinding: '保存登录资料',
        saveBindingHint: '保存只绑定资料，不会触发登录。需要立刻恢复时使用下方“立即重新授权”。',
        bindingSaved: '登录资料已绑定；授权失效后将自动恢复。也可立即发起重新授权。',
        bindingSavedDisabled: '登录资料已保存，自动恢复当前已关闭。需要时可在下方启用。',
        loadErrors: {
          schema_unavailable: '自动授权数据库结构尚未更新。请完成后端数据库迁移后刷新。',
          status_unavailable: '无法读取自动授权状态，请检查数据库连接；将自动重试。',
          endpoint_unavailable: '当前后端尚未提供自动授权接口。请更新并重启后端，然后点击刷新。',
          unauthorized: '登录会话已过期，请重新登录管理员账号。',
          forbidden: '当前账号没有查看自动授权状态的权限，请使用管理员账号。',
          server_error: '自动授权服务异常，将自动重试。请检查后端服务和数据库迁移。',
          network_error: '无法连接自动授权服务，将自动重试。'
        },
        description: '为 OpenAI OAuth 账号配置自动登录。授权失效时先尝试刷新，再通过账号原代理完成登录和 2FA；恢复后自动继续接收调用。',
        workerMissing: '自动登录服务尚未配置，请先在服务端配置并启动浏览器登录服务。',
        keyMissing: '登录凭据加密密钥尚未配置，请先在服务端配置固定密钥。配置完成后可导入或启用账号。',
        importLabel: '导入新账号的登录资料',
        importHint: '每行一条：邮箱----密码----TOTP密钥。密码中的空格和反斜杠会原样提交；密钥应为验证器的长期 Base32 密钥，不是 6 位动态验证码。',
        importPlaceholder: '邮箱----密码----TOTP密钥',
        secretHint: '资料仅用于加密保存和自动登录，不会加入账号导出。关闭面板或完成导入后清空输入。',
        proxyLabel: '新账号的固定代理',
        noProxy: '请选择固定代理（必选）',
        proxyHint: '新建账号必须选择固定出口代理。已有账号继续使用原代理；动态代理地址不能保证出口 IP 一直相同。',
        groupsHint: '分组可选，仅用于新建账号。',
        preserveHint: '新账号创建后自动排队登录，授权成功后可用。已有账号请从账号列表点击“配置 2FA”。',
        importAction: '导入并自动授权',
        importing: '正在保存…',
        importResults: '逐行导入结果',
        validLine: '格式检查通过',
        line: '第 {line} 行',
        accountsLabel: '自动授权账号',
        pollHint: '面板打开时每 5 秒更新状态。关闭面板后，已提交的登录任务继续在后台运行。',
        account: '账号',
        status: '状态',
        lastSuccess: '最近授权成功',
        actions: '操作',
        attempts: '已尝试 {count} 次',
        nextAttempt: '下次尝试：{time}',
        enable: '启用',
        disable: '停用',
        retry: '立即重新授权',
        empty: '尚未配置自动授权账号。',
        loadFailed: '无法加载授权状态，将自动重试。',
        proxiesFailed: '无法加载代理，请重新打开面板后重试。',
        noAvailableProxies: '暂无可用固定代理，请先到代理管理添加并启用代理，再回来导入。',
        importFailed: '提交未确认，请刷新账号列表检查结果后再重试。',
        actionFailed: '操作未确认，请刷新状态后重试。',
        manualFailed: '人工授权未完成。请确认使用原账号及原代理；若授权任务仍在运行，请等待结束后重新生成授权链接。',
        manualAction: '人工授权',
        manualHint: '请先将浏览器设置为账号绑定的同一固定代理，再打开授权链接完成验证。成功后仅解除本次授权停调，保留手动停用和额度限制。',
        statuses: {
          bound: '已绑定 2FA', starting: '正在准备授权', browser_login: '正在登录并验证 2FA',
          idle: '等待授权失效触发', queued: '已排队', pending: '等待执行', refreshing: '正在刷新令牌',
          logging_in: '正在登录', awaiting_2fa: '正在完成 2FA', exchanging: '正在交换授权', verifying: '正在验证授权',
          running: '授权进行中', ready: '授权可用', recovered: '已恢复', success: '授权成功', succeeded: '授权成功',
          failed: '授权失败', retry_wait: '等待重试', cooldown: '冷却中', blocked: '需要处理', needs_manual: '需要人工处理',
          awaiting_manual: '等待人工处理', manual_required: '需要人工处理', disabled: '已停用', created: '已创建',
          updated: '已更新', imported: '已导入', unknown: '状态待更新'
        },
        errors: {
          account_exists: '账号已存在，请从账号列表为该账号配置 2FA。',
          identity_unknown: '无法确认原账号的登录邮箱，请先补全账号邮箱。',
          invalid_account: '此账号不支持自动授权，请使用 OpenAI OAuth 主账号。',
          configuration_failed: '自动授权配置保存失败，请检查后端服务后重试。',
          credentials_updated: '登录资料已更新，请点击立即重新授权以恢复账号。',
          invalid_format: '格式应为邮箱----密码----TOTP密钥，每行一条。',
          invalid_email: '邮箱格式无效。', password_required: '密码不能为空。',
          invalid_totp_secret: '请填写有效的长期 Base32 TOTP 密钥，不是动态验证码。',
          invalid_totp: 'TOTP 密钥或验证码无效，请检查密钥与服务器时间。',
          duplicate_email: '同一批次内邮箱重复。', proxy_required: '新账号必须选择固定代理。',
          invalid_proxy: '代理不可用，请选择有效的固定代理。', proxy_not_found: '绑定的代理不存在。',
          proxy_unavailable: '绑定的代理不可用，任务已停止。', proxy_pool_not_supported: '请为账号配置单一固定代理。',
          proxy_changed: '账号代理已变化，请检查后重新授权。', proxy_ip_changed: '代理出口 IP 已变化，任务已停止。',
          account_not_found: '账号不存在。', account_ambiguous: '邮箱对应多个账号，请先解决重复账号。',
          account_conflict: '邮箱对应的已有账号不符合自动授权要求，请检查重复账号或账号类型。',
          account_changed: '任务期间账号设置发生变化，请检查后重试。', account_mismatch: '登录身份与原账号不一致。',
          identity_mismatch: '登录身份或工作区与原账号不一致，未覆盖凭据。', credentials_missing: '尚未配置登录资料。',
          worker_not_configured: '浏览器登录服务尚未配置。', encryption_key_not_configured: '凭据加密密钥尚未配置。',
          login_failed: '登录失败，请检查资料后重试。', invalid_credentials: '登录资料无效。', invalid_password: '登录密码无效。',
          totp_failed: '2FA 验证失败，请检查密钥与服务器时间。', manual_required: '遇到额外验证，请人工完成授权。',
          captcha_required: '需要人工完成验证码。', email_otp_required: '需要人工完成邮箱验证码。',
          device_verification_required: '需要人工完成设备确认。', network_error: '登录网络请求失败，等待重试。',
          timeout: '登录超时，请稍后重试。', disabled: '自动授权已停用。', busy: '已有授权任务正在执行。',
          cooldown: '正在冷却，请等待下次尝试。', rate_limited: '登录请求受限，请稍后重试。',
          invalid_group: '所选分组不可用。', group_not_found: '所选分组不存在。', import_failed: '该行导入失败，请检查账号设置后重试。',
          refresh_failed: '令牌刷新失败。', state_changed: '账号状态已变化，请刷新后重试。',
          oauth_configuration_error: 'OAuth 客户端配置无效，请检查服务端配置。', persistence_failed: '授权结果保存失败，请检查服务端状态后重试。',
          worker_unavailable: '浏览器登录服务暂不可用。', lock_unavailable: '账号正在被其他任务处理，请稍后重试。',
          secret_unavailable: '无法读取加密登录资料，请检查加密密钥或重新导入。', unknown: '操作失败，请检查配置或人工完成授权。',
          invalid_request: '登录任务参数无效，请检查配置。', invalid_callback: '授权回调无效，请重新授权。',
          unauthorized: '登录服务认证失败，请检查服务端配置。', payload_too_large: '提交内容过大，请减少每批账号数量。',
          unsupported_proxy: '浏览器不支持该代理方式，请使用受支持的固定代理。', unsupported_totp: '不支持该 TOTP 配置，请使用标准 TOTP 密钥。',
          state_mismatch: '授权会话不匹配，任务已停止。', oauth_error: 'OAuth 授权未完成，请检查账号或人工授权。',
          untrusted_login_origin: '登录跳转地址不受信任，任务已停止。', login_timeout: '登录超时，请稍后重试。',
          cancelled: '登录任务已取消。', browser_unavailable: '登录浏览器不可用，请检查登录服务。',
          login_navigation_failed: '无法打开登录页面，请检查代理。', login_flow_unsupported: '当前登录流程需要人工处理。',
          workspace_selection_required: '需要人工选择原账号对应的工作区。', email_verification_required: '需要人工完成邮箱验证码。',
          account_disabled: '上游账号已停用，请检查账号状态。', credentials_rejected: '登录资料被拒绝，请检查邮箱、密码与 TOTP 密钥。'
        }
      },
      viewColumns: '列显示',
