export default {
  ...
  version: {
    ...
    refresh: '刷新',
    sourceMode: '源码构建',
    sourceModeHint: '当前为源码构建，请从号池仓库更新并重新构建；容器在线更新仅适用于正式镜像。',
    checking: '正在检测号池镜像…',
    checkUnknown: '更新状态未知，请刷新重试',
    statusUnknown: '暂时无法读取更新服务状态，当前不能发起更新。',
    helperNotConfigured: '首次使用需在宿主机安装号池更新服务，并配置应用连接。',
    helperUnavailable: '号池更新服务暂不可用，请检查宿主机上的更新服务。',
    recoveryRequired: '上次更新中断，需要在宿主机检查并恢复容器后再继续。',
    updateUnavailable: '当前部署尚未启用容器在线更新。',
    setupInstructions: '查看首次安装说明',
    authRequired: '管理员登录已失效或权限不足，已停止自动检查。请重新登录。',
    confirmTitle: '更新号池镜像',
    confirmContainerUpdate: '将更新到 v{version} 并重建容器，服务会短暂中断。是否继续？',
    submitting: '正在提交更新任务…',
    reconnecting: '容器可能正在重建，正在等待服务恢复。不会重复提交更新。',
    monitorTimeout: '已等待 25 分钟，已停止自动轮询。任务可能仍在运行，请检查宿主机更新服务，或点击刷新查看状态。',
    verifying: '正在核对运行版本与提交号…',
    rolledBackFailure: '更新失败，已恢复旧镜像；本次更新未完成。',
    jobStates: {
      queued: '更新任务已排队',
      pulling: '正在拉取号池镜像',
      recreating: '正在重建容器',
