...
func TestContextPricingSchedulePreservesCacheWrite1h(t *testing.T) {
	...
	require.NoError(t, err)
	require.Len(t, sched.Tiers, 2)
	requirePrice(t, testPtrFloat64(20e-6), sched.Tiers[0].CacheWrite1h, "base 1h")
	requirePrice(t, testPtrFloat64(25e-6), sched.Tiers[1].CacheWrite, "tier 5m")
	requirePrice(t, testPtrFloat64(40e-6), sched.Tiers[1].CacheWrite1h, "tier 1h")
